 ...
 * This file demonstrates how to integrate Nooksway with a web frontend
 */

// For React/Vue/Angular applications
export class NookswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NookswayClient(provider, contractAddress);
